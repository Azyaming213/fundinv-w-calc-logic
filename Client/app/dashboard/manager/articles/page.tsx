...
export default function ManagerArticlesPage() {
  ...
  const fetchArticles = useCallback(async (cat: string) => {
    ...
    try {
      ...
      const data = await api.get<{ articles: Article[] }>(`/api/manager/articles${params}`);
  ...
  return (
    <div className="max-w-6xl mx-auto px-8 py-8">
      <div className="mb-8">
        <h1 className="text-2xl font-semibold text-fundinv-primary">Market News</h1>
        <p className="text-sm text-fundinv-muted mt-1">Latest financial news and market insights</p>
      </div>
